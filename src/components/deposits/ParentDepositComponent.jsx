...
export const ParentComponent = () => {
    ...
    return (
        <>
            ...
            <div className="w-[80rem] h-full grid grid-cols-1 md:grid-cols-2 gap-9 ml-[30rem] p-7">
                <div className="card bg-white rounded-lg shadow-md p-6 border border-gray-200 w-full">
                    <img
