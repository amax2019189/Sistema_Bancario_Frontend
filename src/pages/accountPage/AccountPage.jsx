...
const NavButton = ( { text, id, onClickHandler } ) => {
    return (
        <span className="block px-4 py-2.5 text-white hover:bg-[#00AAE4] hover:text-white rounded-lg" id={id} onClick={() => onClickHandler( id )} style={{ color: 'white', cursor: 'pointer' }}>
            {text}
        </span >
    );
};
